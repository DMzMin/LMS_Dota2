...
##### **unit_order_**
The variables starting with 'unit_order_' (columns 40 - 73 in 'players' data frame) represent the number of physical mouse and keyboard clicks a player did to perfrom certain actions.  The usefulness of these variables are not immediately obvious however an accumulation of all clicks per player per match will be collected since it could be used as an idicator of how advanced a player is or how skillful a player is needed to be to operate a hero effectively.

```{r amalgamate unit_order_}
...
Lets look at the histograms of some of the other key variables.
...
For this study the following 27 variables from the orginal file 'players' will be used:
...
The 'CombinedDF' data frame has 420510 observations across 50 variables and represents the collection of all data that will be discussed in this report. This will be the source for all studies going forward in this project.
