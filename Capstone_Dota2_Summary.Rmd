...
These density plots show that winning matches for Windranger tend to be slightly longer than losing matches. Shadow fiend shows the opposite. This indicates different types of styles of how players should play these heroes. Heroes like Shadow Fiend maybe more successful pushing for a quick win while Windranger may benefit from playing more defensively initially. This analysis shows that further work can be done to understand how team compositions should be put together.
...
Special thanks goes to Dr Guy Maskall for all his help, pointers and direction. There is no way I could have done this course without his help and support.  Thank you!
